...
api.get('/obtener-solicitudes-local/:pagina?/:localID', md_auth.ensuerAuth, SolicitudController.obtenerSolicitudesLocal);
api.get('/obtener-solicitudes-local-aprobadas/:pagina?/:localID', md_auth.ensuerAuth, SolicitudController.obtenerSolicitudesLocalAprobadas);
